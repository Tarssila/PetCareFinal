...
class PetScreen extends StatefulWidget {
  ...
  PetScreen({this.categoryId, this.product});

  @override
  _PetScreenState createState() => _PetScreenState(categoryId, product);
}

class _PetScreenState extends State<PetScreen> with ProductValidator {
  ...
  _PetScreenState(String categoryId, DocumentSnapshot product) :
